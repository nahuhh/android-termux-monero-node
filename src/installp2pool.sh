...
if [ ! -e p2pool-v1.8.tar.gz ]
then
apt install wget nano -y
wget -O p2pool-v1.8.tar.gz https://github.com/SChernykh/p2pool/releases/download/v1.8/p2pool-v1.8-linux-aarch64.tar.gz
tar --one-top-level=p2pool-v1.8/ --strip-components=1 --keep-newer-files -xvf p2pool-v1.8.tar.gz
else
